...
Most of these come down to network reality or how kr36-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

kr36-cli rate-limits like any public site. kr36 already paces
...
Where a surface is gated, kr36 reads a cookie or token you supply
...
`kr36`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what kr36 actually did
